...
#
# Run from the repository root, after extract_b0_trial.R.
...
# written by extract_b0_trial.R. Kept as a separate file so this script
# does not need the multi-gigabyte parquet or the devcontainer.
trial_raw <- read_csv(
  str_c("tmp/b0_trial_", electrode, ".csv"),
...
model <- cmdstan_model("analysis/rbf_stan/rbf_b0_single_trial.stan")
