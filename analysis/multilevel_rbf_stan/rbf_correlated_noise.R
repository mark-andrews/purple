# Single trial, single electrode: RBF basis-function regression with a
# correlated residual process, fitted with nlme::gls.
#
...
# Decimate 1024 -> 128 Hz. Safe because the data are already low-passed
# at 30 Hz, well below the new Nyquist of 64 Hz. Reconstruction error is
# ~0.3% of the signal SD in the epoch interior.
